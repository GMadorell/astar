...
class CostsManager:
    ...
    def combineCosts(self, info1, info2, costs1, costs2):
        ...
        #     length2 = len(costs2)
        #     while j2 < length2:
        #         length_row2 = len(costs2[j2])
        #         i2 = 0
        #         while i2 < length_row2:
        ...
        # for id3 in info2.keys():
        #     # Iterate bigger matrix
        #     i, j = 0, 0
        #     length = len(costs2)
        #     while j < length:
        #         length_row = len(costs2[j])
        #         i = 0
        #         while i < length_row:
        #             # Iterate little matrix
        #             i2, j2 = 0, 0
        #             length2 = len(costs1)
        #             while j2 < length2:
        #                 length_row2 = len(costs1[j2])
        #                 while i2 < length_row2:
        ...
        #     for id1, dic1 in info1.items():
        #         for id2, dic2 in info2.items():
